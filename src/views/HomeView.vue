<template>
  <main>
    <div class="h-screen flex justify-center items-center">
      <div class="flex w-[600px] flex-col text-center">
        <h1 class="w-[600px] mb-5">
          <LogoIcon />
        </h1>
        <h2 class="mb-8 text-2xl md:text-3xl font-bold text-gray-700">Screen Annotation Made Easy</h2>
        <RouterLink to="/task"
